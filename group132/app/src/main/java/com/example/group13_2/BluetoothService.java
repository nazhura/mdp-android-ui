...
public class BluetoothService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        // Send the name of the connected deviceConstants back to the UI Activity
        Message msg = mHandler.obtainMessage(MessageConstants.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(Utils.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private class ConnectThread extends Thread {
        ...
        public void connectionFailed() {
            // Send a failure chat back to the Activity
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                // Share the sent chat back to the UI Activity
